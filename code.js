...
// ------------------------------------------------------ //
    ...
    var init = {
        line    : { x1:0,   y1:0,   x2:200,     y2:200,               lw:0.5,   lc:'#000', ca:'round'  },
        rect    : { x:0,    y:0,    w:100,      h:100,  co:'#fe7',    lw:0.5,   lc:'#000', ra:5        },
        circle  : { x:0,    y:0,    r:50,               co:'#7fe',    lw:0.5,   lc:'#000'              }  }
...
function initiateSVG() {
    ...
    $('#artCtrl').append(`${fl('grid')}<input type='checkbox' />`);
